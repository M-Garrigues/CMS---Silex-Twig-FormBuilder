...
FLUSH PRIVILEGES;
 ...
 USE fc_bdd;-- phpMyAdmin SQL Dump
-- version 4.5.1
-- http://www.phpmyadmin.net
--
-- Client :  127.0.0.1
-- Généré le :  Lun 25 Juillet 2016 à 15:09
...
--
-- Structure de la table `r_docs_tabs`
--
...
--
-- Structure de la table `r_images_tabs`
--
...
CREATE TABLE `t_entries` (
  ...
  `entry_content` varchar(10000) DEFAULT NULL,
  `tab_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_tabs` (
  ...
  `tab_content` varchar(10000) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'Actualités', 'actus', 'test lorem ipsum test lorem ipsum'),
(2, 'Formations', 'formations', 'test loremtest lorem ipsum test lorem ipsumipsum test lor'),
(3, 'Ressources pédagogiques', 'ressources_pedagogiques', 'test lorem ipsum test test lorem ipsum test lorem ipsum'),
(4, 'Astrogebra', 'astrogebra', 'test lorem ipsum test test lorem ipsum test lorem ipsum'),
(5, 'Expériences de physique', 'experiences', 'test lorem ipsum test lortest lorem ipsum test lorem ipsum'),
(6, 'Parrainages', 'parrainages', 'test lorem ipsum test lotest lorem ipsum test lorem ipsumr'),
(7, 'Evénements antérieurs', 'evenements_anterieurs', 'test lorem test lorem ipsum test lorem ipsumipsum test lor');
...
--
-- Index pour la table `r_docs_tabs`
--
ALTER TABLE `r_docs_tabs`
  ADD PRIMARY KEY (`tab_id`,`doc_id`);
...
--
-- Index pour la table `r_images_tabs`
--
ALTER TABLE `r_images_tabs`
  ADD PRIMARY KEY (`tab_id`,`image_id`);
